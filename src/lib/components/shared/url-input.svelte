...
<div class={classNames("relative mt-1 inline-flex w-full", classes)}>
    ...
    <input
        ...
        {...$$restProps}
        class={classNames(
            "peer block w-full appearance-none rounded-r-md border px-3 py-2 placeholder-gray-400 shadow-sm focus:enabled:outline-none focus:enabled:ring-1 sm:text-sm disabled:bg-gray-100",
            errors?.length
