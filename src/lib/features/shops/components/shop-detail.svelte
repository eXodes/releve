<script lang="ts">
    ...
    import { Icon, LocationMarker, Clock, User } from "svelte-hero-icons";

    import { Color } from "$enums/theme";
    import { classNames } from "$utils/style";
    import { getPlainDate, getRelativeDatetime } from "$utils/datetime";
                    ...
                    <aside class="mt-6 xl:hidden">
                        ...
                        <div class="mt-6 space-y-8">
                            <div>
                                ...
                                <ul class="mt-2 leading-8">
                                    {#each shop.deliveryServices as deliveryService (deliveryService)}
                                        <li class="inline">
                                            <div
